...
The IAL, AAL, and FAL SHALL be known to the RP during the federation transaction. This information MAY be pre-established or the IdP MAY communicate this at runtime in the assertion by using, for example, technologies defined in [[RFC 8485]](../_Appendix/references.md#ref-RFC8485) and [[SAML-AC]](../_Appendix/references.md#ref-SAML-AC).
