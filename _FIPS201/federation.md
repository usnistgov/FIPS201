...
While it is possible to process a PIV credential belonging to a different Agency, federation is the recommended way for an Agency to accept and process PIV credentials from an external source.
