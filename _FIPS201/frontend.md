...
Secure messaging may also be used for authentication (i.e., 
SM-Auth authentication mechanism) as the process of establishing secure
messaging authenticates the PIV Card.
