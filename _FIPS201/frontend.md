...
the card. Examples include the cardholder UUID that may appear in the CHUID or the subject name and names that may appear in the subjectAltName extension in the PIV authentication certificate.
