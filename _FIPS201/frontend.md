...
be a 16-byte binary representation of a valid version 4 (random or pseudeorandom) Universally Unique IDentifier (UUID) [[RFC4122]](../_Appendix/references.md#ref-RFC4122). The
