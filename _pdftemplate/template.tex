...
\fancypagestyle{body}
{
        ...
        \fancyhead{}
        \fancyhead[L]{\sc\scriptsize\color{gray}\bfseries\sffamily \VAR{config.report_number}}
...
\vfill
\normalsize{\textbf{\textsc{Category: \VAR{config.category}\hfill Subcategory: \VAR{config.subcategory}}}}
\vspace{8pt}
\hrule
\vfill
