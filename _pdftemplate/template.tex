...
\titleformat{\section}{\LARGE\bfseries\sffamily}{}{0em}{\colorsection}	% required for heading numbering style
\titleformat{\subsection}{\Large\bfseries\sffamily}{}{0em}{}	% required for heading numbering style
\titleformat{\subsubsection}{\large\bfseries\sffamily}{}{0em}{}	% required for heading numbering style
\titleformat{\paragraph}{\normalsize\bfseries\sffamily}{}{0em}{}	% required for heading numbering style
...
\fancypagestyle{body}
{
        ...
        \fancyhead{}
        \fancyhead[R]{\sc\scriptsize\color{gray}\sffamily\pagetitle}
}
...
\newcommand{\pagetitle}{\VAR{page_title}}
