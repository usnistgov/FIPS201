...
\fancypagestyle{body}
{
        ...
        \fancyhead{}
        \fancyhead[L]{\sc\scriptsize\color{gray}\sffamily \VAR{config.report_number}}
        \fancyhead[R]{\sc\scriptsize\color{gray}\sffamily \VAR{config.page_title}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\LARGE{\textbf{\VAR{config.report_number}}}
...
%: for org in config.authors
%: for author in org.names
\normalsize \VAR{author}\\
%: endfor
\textit{\VAR{org.office}}\\
\textit{\VAR{org.unit}}\\
%: if not loop.last
\vspace{12pt}
%: endif
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\normalsize Issued \VAR{config.month} \VAR{config.year}
\vfill
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%  Department of Commerce LOGO - leave as-is
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	

\includegraphics[width=0.25\linewidth]{DoC-logo.eps}\\ 
\vfill
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
