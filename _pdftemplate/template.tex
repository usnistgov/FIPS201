...
\setlength{\parskip}{0.3cm plus 4mm minus 3mm}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\pubnumber}{\VAR{config.report_number}}
\newcommand{\DOI}{\VAR{config.doi_url}}
\newcommand{\monthyear}{\VAR{config.month} \VAR{config.year}}
\newcommand{\pagetitle}{\VAR{config.page_title}}
...
%: if rendered.foreword is not none
...
%: if rendered.appendix is not none
